...
$query = mysqli_query($connection,"SELECT * FROM aktiviti");
?>
...
<br></br>
    <center>
    <center>
            <h2> JADUAL AKTIVITI HARIAN PUSAT LITERASI KANAK KANAK FELDA JELAI </h2>
            </center>
    <section class="forms-section">
    <body>
    <table class="table table-hover" style="background-color: teal;">

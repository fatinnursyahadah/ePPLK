        ...
        <div class="main-content">
          ...
          <div class="header">
            ...
            <div class="clay-category">
              <p><a href="logout.php">LOG KELUAR</p>
            </div>

            <div class="clay-category">
              <p><a href="aktiviti.php">AKTIVITI HARIAN</p>
            </div>
...
<center>
    ...
    <button class="admin" name="submit">ADMIN</button></a><br>

    <a href = "murid/murid_login.php">
    <button class="admin" name="submit">MURID</button></a><br>
    
    <a href = "admin/pemohon.php">
    <button class="admin" name="submit">DAFTAR MURID</button></a><br>
</div>

<?php
    ...
    $papar = mysqli_query($connection, "SELECT * FROM pemohon WHERE id='$id'");
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $query = mysqli_query($connection, "INSERT INTO murid(nama, nokp, pswd, notel, bilAdikB, alamat, alahan, status,
    ...
    <form action="" method="post">
      ...
      ?>
        ...
        <td>
          ...
          NO. TELEFON : <input type="text" name="notel" value="<?php echo $data['notel'] ?>" required="" class="form-control"></br>
        
          ALAMAT  : <input type="text" name="alamat" value="<?php echo $data['alamat'] ?>" required="" class="form-control"></br>
          ...
          ALAHAN  :
            ...
            NAMA IBU  : <input type="text" name="namaibu" value="<?php echo $data['namaibu'] ?>" required="" class="form-control"></br>

            PEKERJAAN IBU  : <input type="text" name="jobibu" value="<?php echo $data['jobibu'] ?>" required="" class="form-control"></br>
      
            NAMA BAPA  : <input type="text" name="namabapa" value="<?php echo $data['namabapa'] ?>" required="" class="form-control"></br>
      
            PEKERJAAN BAPA  : <input type="text" name="jobbapa" value="<?php echo $data['jobbapa'] ?>" required="" class="form-control"></br>

            NAMA PENJAGA  : <input type="text" name="namapenjaga" value="<?php echo $data['namapenjaga'] ?>" required="" class="form-control"></br>

            PEKERJAAN PENJAGA  : <input type="text" name="jobpenjaga" value="<?php echo $data['jobpenjaga'] ?>" required="" class="form-control"></br>
      
            TAHUN KEMASUKKAN  : <input type="text" name="tahun" value="<?php echo $data['tahun'] ?>" required="" class="form-control"></br>

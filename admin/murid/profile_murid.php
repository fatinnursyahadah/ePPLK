  ...
  <h2> SISTEM PENDAFTARAN PUSAT LITERASI KANAK KANAK FELDA JELAI</h2>
        ...
        <div class="main-content">
          ...
          <div class="header">
            ...
            <div class="clay-category">
              <p><a href="aktiviti_murid.php">AKTIVITI HARIAN</a></p>
            </div>
          </div>
<body>
<html>
      ...
      <div class="container">
       ...
       <div class="col-12 text-center name">
         <div class="d-flex justify-content-between">
          ...
          <span> <?php echo $display['nokp'];  ?></span>
         </div>
        </div>
        <div class="col-12 text-center name">
         <div class="d-flex justify-content-between">
          <div>PASSWORD :</div>
          <span> <?php echo $display['pswd'];  ?></span>
         </div>
        </div>
        <div class="col-12 text-center name">
         <div class="d-flex justify-content-between">
          <div>NO TELEFON :</div>
          <span> <?php echo $display['notel'];  ?></span>
         </div>
        </div>
        <div class="col-12 text-center name">
         <div class="d-flex justify-content-between">
          <div>ALAMAT :</div>
          <span> <?php echo $display['alamat'];  ?></span>
         </div>
        </div>
        <div class="col-12 text-center name">
         <div class="d-flex justify-content-between">
          <div>BIL ADIK BERADIK :</div>
          <span> <?php echo $display['bilAdikB'];  ?></span>
         </div>
        </div>
        <div class="col-12 text-center name">
         <div class="d-flex justify-content-between">
          <div>ALAHAN :</div>
          <span> <?php echo $display['alahan'];  ?></span>
         </div>
        </div>
        <div class="col-12 text-center name">
         <div class="d-flex justify-content-between">
          <div>STATUS :</div>
          <span> <?php echo $display['status']; } ?></span>
         </div>
        </div>
  </div>
  </div>

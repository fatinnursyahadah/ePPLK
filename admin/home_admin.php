  ...
  <div class="clay-category">
          ...
          <div class="featured-clay">
            ...
            <div>
              <div></div>
              <div>
                <h3>SENARAI NAMA MURID</h3>
                <a href="senarai_murid.php" title="featured clay">NAMA</a>
              </div>
            </div>
            ...
            <div>
              <div></div>
              <div>
                <h3>PROFILE IBU/BAPA</h3>
                <a href="profile_ibubapa.php" title="featured clay">PROFILE</a>
              </div>
            </div>
            ...
            <div>
              <div></div>
              <div>
                <h3>KEMASKINI DATA MURID</h3>
                <a href="update.php" title="featured clay">KEMASKINI</a>
              </div>
            </div>
            ...
            <div>
              ...
              <div>
                ...
                <a href="mohon.php" title="featured clay">PEMOHON</a>
              </div>
            </div>

...
$papar = mysqli_query($connection, "SELECT * FROM murid");
...
<body>
<form action = "profile_ibubapa_search.php" method ="post">
        <div class = "topnav">
        <input type ="text" class = "form-control" text-color="black" name="search" placeholder = "Masukkan Nama Murid">
        <center><button class = "btn btn-primary">Cari</button> </center>
    </div>
    </form>
  <?php
